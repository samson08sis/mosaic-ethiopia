          ...
          <div
            ...
            message.content[message?.responseIndex || 0].sender ===
              ...
              <ReactMarkdown
                ...
                remarkPlugins={[]}>
                {message.content[message?.responseIndex ?? 0].content}
              </ReactMarkdown>
            ) : (
              <p className="text-sm">
                {message.content[message?.responseIndex ?? 0].content}
            ...
            {message.content[message?.responseIndex ?? 0].sender !==
              ...
              <div className="flex flex-row space-x-2">
                ...
                {message.responseIndex && message.responseIndex >= 0 && (
                  <span className="flex justify-center items-center flow-row text-sm text-opacity-30 space-x-1">
                    ...
                    <span className="tracking-wider opacity-70">{`${message.responseIndex}/${message.content.length}`}</span>
                    <button
