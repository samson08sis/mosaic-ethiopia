      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-12">
        ...
        <div className="mb-12 lg:mb-0 lg:w-5/12 text-center lg:text-left">
          ...
          <p className="text-lg mb-8">
            Ethiopia, the land of origins, invites you to discover its ancient
            wonders, diverse cultures, and breathtaking landscapes. From the
            rock-hewn churches of Lalibela to the otherworldly landscapes of the
            Danakil Depression, our carefully curated tours will take you on an
            unforgettable journey through one of Africa's most fascinating
            countries.
          </p>
          <Link
            href="/about"
