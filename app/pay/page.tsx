      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          {paymentStep === 1 ? (
                  ...
                  {paymentMethod === "paypal" && (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 mb-6">
                        Click the button below to log in to your PayPal account
                  ...
                  {paymentMethod === "bank-transfer" && (
                    <div className="space-y-6">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        ...
                        to confirm your payment. Our team will verify the
                        transfer and update your booking status.
                      </p>
            ...
            <div className="bg-card rounded-xl shadow-lg overflow-hidden p-8">
